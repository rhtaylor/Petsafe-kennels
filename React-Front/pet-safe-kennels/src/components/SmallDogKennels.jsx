...
const smallDogKennelArray = [{title: 'Wrap Around', info: 'Custom kennel to wrap the contours of the house. Attached to house with doggy-door.',img:  WrapAroundKennel, size: '20x3'}, 
